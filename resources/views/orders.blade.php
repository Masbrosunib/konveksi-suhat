  ...
  <div class="table-responsive" id="table_order">
    <table class="table table-stripped">
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td><img src="images/varsity.png" style="max-width: 100px;"></td>
                <td>Lorem ipsum</td>
                <td>12</td>
                <td>Rp260.000</td>
                <td><button class="btn btn-sm btn-warning">Click here</button></td>
                <td><button class="btn btn-sm btn-secondary">X</button></td>
            </tr>
            <tr>
              <td>2</td>
              <td><img src="images/varsity.png" style="max-width: 100px;"></td>
